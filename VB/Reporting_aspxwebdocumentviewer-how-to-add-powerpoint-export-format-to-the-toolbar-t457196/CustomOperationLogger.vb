...
Namespace DVCustomExportOption
    Public Class CustomOperationLogger
        ...
        Private Function ExportToPowerPoint(ByVal printingSystem As PrintingSystemBase, ByVal documentId As String) As Byte()
            ...
            Dim exportOptions As ImageExportOptions = New ImageExportOptions With { _
                .ExportMode = ImageExportMode.SingleFilePageByPage, _
                .Format = ImageFormat.Png, _
                .PageBorderColor = Color.White, _
                .Resolution = 600 _
            }
